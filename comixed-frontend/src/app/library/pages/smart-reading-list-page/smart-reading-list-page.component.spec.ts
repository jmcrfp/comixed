...
import { SmartReadingListPageComponent } from './smart-reading-list-page.component';
import {
  AbstractControl,
  FormsModule,
  ReactiveFormsModule
...
describe('SmartReadingListPageComponent', () => {
  let component: SmartReadingListPageComponent;
  let fixture: ComponentFixture<SmartReadingListPageComponent>;
  let activated_route: ActivatedRoute;
  let smart_reading_list_name: AbstractControl;
  let smart_reading_list_summary: AbstractControl;
  ...
  beforeEach(async(() => {
    ...
    fixture = TestBed.createComponent(SmartReadingListPageComponent);
    component = fixture.componentInstance;
    activated_route = TestBed.get(ActivatedRoute);
    fixture.detectChanges();
    smart_reading_list_name = component.smartReadingListForm.controls['name'];
    smart_reading_list_summary = component.smartReadingListForm.controls['summary'];
  }));
